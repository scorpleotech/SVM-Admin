...
const Default = () => {
  ...
  function getData() {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/variants/${id}`)
      .then((response) => {
  ...
  const onSubmit = (Data) => {
    axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/variants/${id}`, Data)
      .then((res) => {
        if (res.data.variant == "error") {
          message.error("Variants Not Updated" + res.data.messagge);
        } else {
