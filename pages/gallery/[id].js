...
const Default = ({ getData = [] }) => {
  ...
  function getDataFc() {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/gallery/${id}`)
      .then((response) => {
  ...
  const onSubmit = async (Data) => {
    ...
    axios
      .put(`${process.env.NEXT_PUBLIC_API_URL}/gallery/${id}`, payload)
      .then((res) => {
        ...
        >
          ...
          {imageType === "image" && (
            <>
              ...
              >
                <Upload
                  ...
                  beforeUpload={(file) => {
                    ...
                    if (!isJPG) {
                      message.error(
                        intl.messages["app.pages.brands.onlyImage"]
                      );
              ...
              >
                <Image
                  src={`${process.env.NEXT_PUBLIC_API_URL}${previewImg?.replace(
                    "../admin/public/",
                    ""
                  )}`}
                  width={200}
                ...
                >
                  <Upload
                    ...
                    beforeUpload={async (file) => {
                      ...
                      const isValidDimensions = await checkImageDimensions(
                        file
                      );
