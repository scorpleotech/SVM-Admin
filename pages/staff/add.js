...
const Default = () => {
  ...
  const onSubmit = async (Data) => {
    ...
    Data["isStaff"] = true;
    axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/staff/add`, Data)
      .then((res) => {
        if (res.data.variant == "error") {
          console.log("Deeeeeieieeieiei", res.data);
          ...
          axios
            .post(
              `${process.env.NEXT_PUBLIC_API_URL}/staff/${res.data.data._id}`,
              staffUpdate
            )
            .then((res) => {
              if (res.data.variant == "error") {
                console.log("Deeeeeieieeieiei", res.data);
                console.log("Deeeeeieieeieiei", res.data.message);
                message.error("Staff Not Added" + res.data.messagge);
              } else {
            ...
            .catch((err) => {
              console.log("Deeeeeieieeieiei", err);
