...
const Default = () => {
  ...
  const handleAadhaarVerify = async () => {
    try {
      const aadhaar_nuumber = form.getFieldValue("aadhar_number");
      ...
      if (aadhaar_nuumber == null || aadhaar_nuumber.length != 12) {
        message.error("Invalid Aadhaar Number");
        return;
      }

      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/agent/aadhaar/verify`,
        {
          aadhaarNumber: aadhaar_nuumber,
          phone: phone,
        }
      );
  ...
  const handleOtpVerify = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/agent/aadhaar/verify/otp`,
        {
          otp: otp,
        }
      );
  ...
  const onSubmit = async (Data) => {
    ...
    axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/agent`, Data)
      .then((res) => {
        if (res.data.variant == "error") {
          message.error("Agent Not Registered" + res.data.messagge);
        } else {
  ...
  return (
    <div>
      ...
      <Card className="card" title="Agent Add">
        <Form
          {...formItemLayout}
          form={form}
          name="add"
        ...
        >
          ...
          {!aadhaarVerified && (
            <Form.Item>
              <Button type="primary" onClick={handleAadhaarVerify}>
                Verify Aadhaar
              </Button>
            </Form.Item>
          )}
          ...
          {user?.role?.superadmin ? (
            ...
            >
              ...
              <Divider />
              <Checkbox
                value={state.role["homeview"]}
                checked={state.role["homeview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["homeview"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                Home view
              ...
              <br />
              <br />
              <span>About Us View</span>
              <Divider />
              <Checkbox
                value={state.role["aboutview"]}
                checked={state.role["aboutview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["aboutview"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                About US
              ...
              <Divider />
              <Checkbox
                value={state.role["tcoview"]}
                checked={state.role["tcoview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tcoview"] = e.target.checked;
                  if (e.target.checked == false) {
                    deg["tcoonlyyou"] = false;
                    deg["tco/list"] = false;
                    deg["tco/add"] = false;
                    deg["tco/id"] = false;
                    deg["tco/delete"] = false;
                  }
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["tcoonlyyou"]}
                checked={state.role["tcoonlyyou"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tcoonlyyou"] = e.target.checked;
                  deg["tco/list"] = false;
                  console.log(deg);
                  seTstate({ ...state, role: deg });
                }}
              ...
              <Checkbox
                value={state.role["tco/list"]}
                checked={state.role["tco/list"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tco/list"] = e.target.checked;
                  deg["tcoonlyyou"] = false;
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["tco/add"]}
                checked={state.role["tco/add"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tco/add"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["tco/id"]}
                checked={state.role["tco/id"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tco/id"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["tco/delete"]}
                checked={state.role["tco/delete"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["tco/delete"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                <IntlMessages id="app.pages.staff.deleteData" />
              ...
              <Divider />
              <Checkbox
                value={state.role["applicationview"]}
                checked={state.role["applicationview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["applicationview"] = e.target.checked;
                  if (e.target.checked == false) {
                    deg["applicationonlyyou"] = false;
                    deg["application/list"] = false;
                    deg["application/add"] = false;
                    deg["application/id"] = false;
                    deg["application/delete"] = false;
                  }
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["applicationonlyyou"]}
                checked={state.role["applicationonlyyou"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["applicationonlyyou"] = e.target.checked;
                  deg["application/list"] = false;
                  console.log(deg);
                  seTstate({ ...state, role: deg });
                }}
              ...
              <Checkbox
                value={state.role["application/list"]}
                checked={state.role["application/list"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["application/list"] = e.target.checked;
                  deg["applicationonlyyou"] = false;
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["application/add"]}
                checked={state.role["application/add"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["application/add"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["application/id"]}
                checked={state.role["application/id"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["application/id"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["application/delete"]}
                checked={state.role["application/delete"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["application/delete"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                <IntlMessages id="app.pages.staff.deleteData" />
              ...
              <Divider />
              <Checkbox
                value={state.role["careerview"]}
                checked={state.role["careerview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["careerview"] = e.target.checked;
                  if (e.target.checked == false) {
                    deg["careeronlyyou"] = false;
                    deg["career/list"] = false;
                    deg["career/add"] = false;
                    deg["career/id"] = false;
                    deg["career/delete"] = false;
                  }
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["careeronlyyou"]}
                checked={state.role["careeronlyyou"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["careeronlyyou"] = e.target.checked;
                  deg["career/list"] = false;
                  console.log(deg);
                  seTstate({ ...state, role: deg });
                }}
              ...
              <Checkbox
                value={state.role["career/list"]}
                checked={state.role["career/list"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["career/list"] = e.target.checked;
                  deg["careeronlyyou"] = false;
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["career/add"]}
                checked={state.role["career/add"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["career/add"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["career/id"]}
                checked={state.role["career/id"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["career/id"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["career/delete"]}
                checked={state.role["career/delete"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["career/delete"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                <IntlMessages id="app.pages.staff.deleteData" />
              ...
              <br /> <br />
              <br />
              <span>Frontend Values</span>
              <Divider />
              <Checkbox
                value={state.role["valuesview"]}
                checked={state.role["valuesview"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["valuesview"] = e.target.checked;
                  if (e.target.checked == false) {
                    deg["valuesonlyyou"] = false;
                    deg["values/list"] = false;
                    deg["values/add"] = false;
                    deg["values/id"] = false;
                    deg["values/delete"] = false;
                  }
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["valuesonlyyou"]}
                checked={state.role["valuesonlyyou"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["valuesonlyyou"] = e.target.checked;
                  deg["values/list"] = false;
                  console.log(deg);
                  seTstate({ ...state, role: deg });
                }}
              ...
              <Checkbox
                value={state.role["values/list"]}
                checked={state.role["values/list"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["values/list"] = e.target.checked;
                  deg["valuesonlyyou"] = false;
                  seTstate({ ...state, role: deg });
                }}
              >
              ...
              <Checkbox
                value={state.role["values/add"]}
                checked={state.role["values/add"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["values/add"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["values/id"]}
                checked={state.role["values/id"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["values/id"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                {" "}
              ...
              <Checkbox
                value={state.role["values/delete"]}
                checked={state.role["values/delete"]}
                disabled={state.role["superadmin"] ? true : false}
                onChange={(e) => {
                  const deg = state.role;
                  deg["values/delete"] = e.target.checked;
                  seTstate({ ...state, role: deg });
                }}
              >
                <IntlMessages id="app.pages.staff.deleteData" />
          ...
          <Form.Item {...tailFormItemLayout}>
            <Button type="primary" htmlType="submit" disabled={!otpVerified}>
