export default {
  ...
  getCategoriesTree: (data) => {
    ...
    // };
    const nest = (items, _id = null, link = "categories_id") => {
      const filteredItems = items.filter((item) => item[link] === _id);
    ...
    const datade = clean(nest(data));
    console.log("dtata", datade);
    console.log("clean data", clean(nest(data)));
